...
main1 Branch20 TagsGo to fileCodeOpen more actions menuFolders and filesNameNameLast commit messageLast commit dateLatest commitnashsurelease: v0.4.3 — fix Ollama LAN connection (always send Origin: http…Open commit detailssuccessApr 28, 20261434e08 · Apr 28, 2026History359 CommitsOpen commit details359 Commits.github/workflows.github/workflowsRevert "ci: re-enable Intel Mac builds via macos-13 runner + universa…Apr 25, 2026assetsassetsdocs: sync EN README with CN — add overview, community, insights scre…Apr 10, 2026extensionextensionfix: cross-platform compatibility audit — macOS, Windows, LinuxApr 8, 2026plansplansplan: multimodal image extraction + indexingApr 27, 2026src-taurisrc-taurirelease: v0.4.3 — fix Ollama LAN connection (always send Origin: http…Apr 28, 2026srcsrcrelease: v0.4.3 — fix Ollama LAN connection (always send Origin: http…Apr 28, 2026.gitignore.gitignorefeat(multimodal Phase 1): Rust image extraction for PDF / PPTX / DOCXApr 27, 2026LICENSELICENSEfix: correct README nav anchors + complete GPL v3 license textApr 8, 2026README.mdREADME.mddocs: surface multimodal image ingestion in README features listApr 28, 2026README_CN.mdREADME_CN.mddocs: surface multimodal image ingestion in README features listApr 28, 2026components.jsoncomponents.jsonfeat: initial commitApr 5, 2026index.htmlindex.htmlchore: scaffold Tauri v2 + React + TypeScript projectApr 5, 2026llm-wiki.mdllm-wiki.mdchore: scaffold Tauri v2 + React + TypeScript projectApr 5, 2026logo.jpglogo.jpgfeat: set app logo from logo.jpg — all icon sizes generated for macOS…Apr 8, 2026package-lock.jsonpackage-lock.jsonrelease: v0.4.1 — update banner UX + system browser openerApr 28, 2026package.jsonpackage.jsonrelease: v0.4.3 — fix Ollama LAN connection (always send Origin: http…Apr 28, 2026tsconfig.app.jsontsconfig.app.jsonfeat: initial commitApr 5, 2026tsconfig.jsontsconfig.jsonfeat: initial commitApr 5, 2026tsconfig.node.jsontsconfig.node.jsonchore: scaffold Tauri v2 + React + TypeScript projectApr 5, 2026vite.config.tsvite.config.tsfeat(embedding/rag Phase 5): Settings UI + RAG test coverageApr 24, 2026View all filesRepository files navigationLLM Wiki
