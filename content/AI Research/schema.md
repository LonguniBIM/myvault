...
Entity pages for GitHub repos also include:
```yaml
...
use_case: []          # e.g., [web-scraping, data-extraction]
status: active | archived | unmaintained
```
...
Comparison pages also include:
```yaml
use_case: ""           # the shared use case being compared
repos: []              # list of [[entity-slug]] being compared
