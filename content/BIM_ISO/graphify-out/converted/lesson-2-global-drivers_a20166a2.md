<!-- converted from lesson-2-global-drivers.docx -->
...
Source audio: Lesson 2 - Global Drivers - BIM ISO 19650 12 Project Delivery Un (6).mp3
## Global Population
...
Source audio: Lesson 2 - Global Drivers - BIM ISO 19650 12 Project Delivery Un (7).mp3
...
Source audio: Lesson 2 - Global Drivers - BIM ISO 19650 12 Project Delivery Un (8).mp3
...
Source audio: Lesson 2 - Global Drivers - BIM ISO 19650 12 Project Delivery Un (4).mp3

https://www.breeam.com(opens in a new tab)
## Carbon Reduction
The UK is Committed to 80% Net Zero Carbon by 2050
Audio transcript (00:29)
...
Source audio: Lesson 2 - Global Drivers - BIM ISO 19650 12 Project Delivery Un (9).mp3
...
Source audio: Lesson 2 - Global Drivers - BIM ISO 19650 12 Project Delivery Un (10).mp3
...
Source audio: Lesson 2 - Global Drivers - BIM ISO 19650 12 Project Delivery Un (5).mp3
...
Help you to Understand the value of a whole life approach rather than capital-led.
[CONTINUE]
| ⧉ Audio placeholder (00:22) — no local audio matched this placeholder |
| --- |
| ⧉ Audio placeholder (00:17) — no local audio matched this placeholder |
| --- |
| ⧉ Audio placeholder (00:53) — no local audio matched this placeholder |
| --- |