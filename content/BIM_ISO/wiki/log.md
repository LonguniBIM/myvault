...
- Extracted [lesson]: **Unit 2 - Lesson 3 - UK BIM Maturity** (from `Unit 2 - Lesson 3`)
- Extracted [lesson]: **Unit 2 - Lesson 2 - BIM Dimensions** (from `Unit 2 - Lesson 2`)
- Extracted [lesson]: **Unit 2 - Lesson 1 - BIM Terminology & Acronyms** (from `Unit 2 - Lesson 1`)
- Extracted [lesson]: **Unit 1 - Construction 4.0** (from `Unit 1 - Lesson 6`)
- Extracted [lesson]: **Unit 1 - Lesson 5 - Making Change Happen** (from `Unit 1 - Lesson 5`)
- Extracted [lesson]: **Unit 1 - Lesson 4 - The Effect of Poor Information** (from `Unit 1 - Lesson 4`)
- Extracted [lesson]: **Unit 1 - Lesson 3 - A History of BIM** (from `Unit 1 - Lesson 3`)
- Extracted [lesson]: **Unit 1 - Lesson 2 - Global Drivers** (from `Unit 1 - Lesson 2`)
- Extracted [lesson]: **Unit 1 - Lesson 1 - BIM Defined** (from `Unit 1 - Lesson 1`)
- Extracted [lesson]: **Lesson 4 - Global BIM Adoption** (from `Unit 2 - Lesson 4`)
- Extracted [lesson]: **Lesson 3 - UK BIM Maturity** (from `Unit 2 - Lesson 3`)
- Extracted [lesson]: **Lesson 2 - BIM Dimensions** (from `Unit 2 - Lesson 2`)
- Extracted [lesson]: **Lesson 1 - BIM Terminology & Acronyms** (from `Unit 2 - Lesson 1`)
## 2026-07-25
...
- Wrote `schema.md` (page types, naming, frontmatter, ten-question analysis framework â€” adapted from `purpose.md` sub-questions) and `CLAUDE.md` (agent operating guide) tailored to BIM ISO 19650
