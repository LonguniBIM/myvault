---
title: "Unit 4 - Lesson 6 - Establish Shared Resources, CDE & Protocol"
type: source
tags:
  ...
  - critical
  - high
source_url: https://elearning.bre.ac/pluginfile.php/191404/mod_resource/content/10/content/index.html#/lessons/tR0BH9oVLFL7LiB5v-mf0tklIsRwZXhs
...
> This lesson will give an overview to ISO 9650, Part Two, clauses 5.16, 5.17 and 5.18.
...
![Part 5: Security-minded approach to information management](unit-4-lesson-6-establish-shared-resources-cde-protocol/assets/Hsvbp8JHL61WpYvk_kCBbBT8uHNWmUPDD.png)
...
>
> Source: [Lesson 6 - Establish Shared Resources CDE Protocol - ISO 19650 1.mp3](unit-4-lesson-6-establish-shared-resources-cde-protocol/assets/Lesson 6 - Establish Shared Resources CDE Protocol - ISO 19650 1.mp3)

## CDE Solution Requirements

![m4s264v2.PNG](unit-4-lesson-6-establish-shared-resources-cde-protocol/assets/XET54oTZgTIcEB04_B0Kqmx5sohk5_d5F.png)
...
![m4s291.PNG](unit-4-lesson-6-establish-shared-resources-cde-protocol/assets/GTgYv_le13TcEVQI_rBF5HnsAO2-rlEkf.jpg)

> The CDE is both a technical solution, and a workflow process, not a piece of software.

![m4s291-1.PNG](unit-4-lesson-6-establish-shared-resources-cde-protocol/assets/IVoOUhF2Pq2JPMw0_1f8_suASswoifoCt.png)

![m4s292.PNG](unit-4-lesson-6-establish-shared-resources-cde-protocol/assets/dGR7sFnz5DjsSS08_lGCMdVHmF--Y6Be4.jpg)
...
![m4s294.PNG](unit-4-lesson-6-establish-shared-resources-cde-protocol/assets/LYoLXh8njbRE3i8Y_TxrWDFfLxzmVQM2w.jpg)
...
>
> Source: [Lesson 6 - Establish Shared Resources CDE Protocol - ISO 19650 1 (1).mp3](unit-4-lesson-6-establish-shared-resources-cde-protocol/assets/Lesson 6 - Establish Shared Resources CDE Protocol - ISO 19650 1 (1).mp3)
...
![m4s296.PNG](unit-4-lesson-6-establish-shared-resources-cde-protocol/assets/ZF7tlLT8YKS55oby__03z9mjzN5XF8SnJ.png)

## Assessment & Need Activities


![m4s297.PNG](unit-4-lesson-6-establish-shared-resources-cde-protocol/assets/ydQsm-UHwOLbjgbW_5h-pdzOV3QchNRJ1.png)
...
>
> Source: [Lesson 6 - Establish Shared Resources CDE Protocol - ISO 19650 1 (2).mp3](unit-4-lesson-6-establish-shared-resources-cde-protocol/assets/Lesson 6 - Establish Shared Resources CDE Protocol - ISO 19650 1 (2).mp3)

Activities for assessment and need are shown in Figure 4 below.

![ISO 19650-2 clause 5.1.8](unit-4-lesson-6-establish-shared-resources-cde-protocol/assets/PGuAu8eWfZshVDvb_Q3XUQC_dQUlQPZAJ.jpg)
...
![unit complete.PNG](unit-4-lesson-6-establish-shared-resources-cde-protocol/assets/03lEasUCZ3T7sZ55_V5zgIvziGVLWPWKZ.png)
...
### 1. Problem
How does the appointing party ensure the project has an operational Common Data Environment (CDE), agreed contractual protocols, and shared resources before procuring delivery teams?

### 2. Applicability
- **Stage**: `assessment-need` (ISO 19650-2 §5.1.6, §5.1.7, §5.1.8).
- **Scope**: Project-wide CDE solution and legal/contractual protocol.
- **Documents**: [[common-data-environment-protocol]], CDE Solution Requirements, Shared Resources.

### 3. Process
1. Appointing party collates reference information and shared resources (§5.1.6).
2. Appointing party establishes the project CDE solution (§5.1.7) ensuring unique container IDs, status/revision/classification attributes, transition workflows, and access controls.
3. Appointing party establishes the project Information Protocol / CDE Protocol (§5.1.8) defining legal rights, data reliance, security obligations, and IP.

### 4. Evidence
- Configured and tested CDE environment.
- Executed Information Protocol (e.g., CIC BIM Protocol or UK BIM Framework Information Protocol).
- CDE User Access & Permission Matrix.

### 5. Principles
- **Container Level Governance**: CDE manages information at the container level (file/model), tracking state, revision, and status.
- **Contractual Inclusion**: The information protocol must be incorporated into all project appointments.

### 6. Risks & Anti-patterns
- Procuring delivery teams before the CDE is configured or tested.
- Relying on generic cloud storage (Dropbox/Google Drive) lacking metadata and ISO 19650 status/revision gates.

### 7. Operationalization
- Standard CDE Configuration Checklist and Protocol Appendices.

### 8. Skill Test
Can this become a Skill?
**Yes** — Candidate: `cde-protocol-assessor` / `cde-setup-validator`.

### 9. Skill Design
- **Supported Role**: CDE Solution Architect / Legal Counsel / Information Manager.
- **Trigger**: Project mobilization / appointment drafting.

### 10. Validation Plan
Test container workflow transitions (WIP -> Shared -> Published) on the configured CDE before project kickoff.

---

## Knowledge Space Links
- **Entities**: [[common-data-environment-protocol]], [[appointing-party]], [[shared-resources]]
- **Concepts**: [[cde-solution-architecture]]
- **Methodologies**: [[establish-cde-protocol-method]]
