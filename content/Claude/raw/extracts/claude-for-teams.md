...
created: 2026-05-10
updated: 2026-05-10
source_file: "Claude for teams.md"
file_type: "text"
---

# Claude For Teams

**Source**: `Claude for teams.md`
...
---
title: "Claude for teams."
source: "https://ruben.substack.com/p/claude-for-teams"
author:
  - "[[Ruben Hassid]]"
published: 2026-03-11
created: 2026-05-09
description: "How to set up Claude for your team in 7 days (so they actually use it):"
tags:
  - "clippings"
---
...
1. How to set up Claude’s team plan.
2. Monday: How to set up ‘Projects’.
3. Tuesday: How to create ‘Prompt Templates’.
4. Wednesday: Test your Project for a ‘wow’.
5. Thursday: Don’t train 10 people. Convert 1.
6. Friday: How to quickly roll it out for the team.
7. What happens next?
...
1. Go to **[claude.com/pricing/team](https://claude.com/pricing/team)**.
2. Minimum seats: **5**, up to a maximum of **150**.
3. I highly suggest the **Premium** seat if you’re seriously using it.
4. If you are an **enterprise**, go to **[claude.ai/create/enterprise/qualification](https://claude.ai/create/enterprise/qualification)**.

![](https://substackcdn.com/image/fetch/$s_!Jjzd!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc83895ea-12f0-4b91-9450-091561b175a4_2072x1460.png)

Go for Premium seats if you’re using it every day. Standard for less than twice a week. In between, it’s your call, but I’d go Premium still.

Claude does not train on your data (like every AI-team plan).

![](https://substackcdn.com/image/fetch/$s_!Q3No!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1bec7ffe-0861-4a91-8493-64d3bd18f784_3210x1028.png)

Quite obvious, but people keep asking me this question.

Here’s what they say around security, depending on the tier level:

![](https://substackcdn.com/image/fetch/$s_!E0c0!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F448d2845-466f-4f9d-abe2-b530856dec46_2438x1596.png)

Pretty standard and solid.
...
![Image](https://substackcdn.com/image/fetch/$s_!Pc1h!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F7e3bb596-d2a1-45d2-baf2-d3ec80acf720_1280x1600.jpeg)

I prefer Claude Cowork for personal use. But Projects for teams.
...
Start now. Use AskUserQuestion.
```

I will follow your steps by creating my own Project folder for a fake company.

I called it RubenLegal, a law firm in the US:

![](https://substackcdn.com/image/fetch/$s_!xbWD!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F386eea30-7e32-446f-943e-f9ea6c0573a1_3356x1746.png)

Here’s an example with a (fake) legal firm. Claude starts asking me questions.

![](https://substackcdn.com/image/fetch/$s_!E4VG!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdcc71106-8eb4-47ba-8066-fc9499abf1cd_1716x1702.png)

Once I answered four Q&As, Claude recommended five Projects.
...
![](https://substackcdn.com/image/fetch/$s_!BecK!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff5043de1-93ac-4a82-90bc-0235f34e5766_3456x1922.png)

On the homepage of Claude, go to Projects.

![](https://substackcdn.com/image/fetch/$s_!yfwv!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb03c0d26-a2dd-41d5-be94-16755f262e60_3456x1920.png)

Go first to Team → then click on New project.

![](https://substackcdn.com/image/fetch/$s_!vN6Z!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fcd4e0885-a0ac-44da-8a6a-43e87d4623ab_1742x1460.png)

Give it the name Claude suggested, write a quick “What are you trying to achieve,” and make it visible to the entire workspace.
...
![](https://substackcdn.com/image/fetch/$s_!heqX!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F634f0141-6d1c-409a-893e-62bc99b33aba_3456x1920.png)

Add the files Claude suggested for this one Project. Think past deliverables or guidelines. What would you give to a new employee?
...
![](https://substackcdn.com/image/fetch/$s_!1Vxu!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Faf9a1ec7-81cd-4788-9925-cc1e8ce374a0_3456x1922.png)

Click on the + next to Instructions. Copy and paste the ones from Claude. Edit & save.

![](https://substackcdn.com/image/fetch/$s_!htHe!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F98a34a63-5c54-4ff2-a0f9-f75c331c1901_3456x1924.png)

You can even add tools to your Project, like Web search or Extended thinking. Turn on for most.
...
Claude will then give you a solid Custom instructions prompt like this:

![](https://substackcdn.com/image/fetch/$s_!cfaG!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F1bec2bf3-3f6c-467d-a596-66c59ec40515_2030x1716.png)

It gave me solid custom instructions I can tweak a little.
...
If it nails the tone and format, the Project is ready. If something’s off, tweak the instructions. Takes 2 minutes per Project.

![](https://substackcdn.com/image/fetch/$s_!wbWr!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff5d44787-68dd-432d-be0a-ce89be85b9f5_3456x1924.png)

Here’s again my fake legal firm. And the result of the test is… impressive to say the least. It’s 8 pages by the way.
...
Review what Claude gives you. Tweak it if needed. Save it to that Project’s Knowledge (probably on your Drive). Repeat for each Project. 5 minutes / Project.

![](https://substackcdn.com/image/fetch/$s_!U0qM!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb1196220-1e6c-4a8c-9b47-fe859699e016_3454x1916.png)
...
![](https://substackcdn.com/image/fetch/$s_!kmb1!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fbef1605e-0917-4be3-8027-391810675a6e_3456x1920.png)

Here’s how to give access to one person in your team.
...
End on an invitation for an onboarding call.
```

**Step 3 → Send and seed.**
...
**Friday done. Probably 60 minutes.**
...
![The Hunting Ape — The Extinctions](https://substackcdn.com/image/fetch/$s_!2fJZ!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6e1edfe5-bf8a-43b6-b5c4-8469d408713d_2021x1631.jpeg)

It’s how we evolved. Being smart, together.
...
<iframe src="https://substack.com/embed/polymarket/which-company-has-best-ai-model-end-of-june?graphMode=true&amp;itemEntityKey=p-190291908" width="100%" height="200px" frameborder="0"></iframe>
