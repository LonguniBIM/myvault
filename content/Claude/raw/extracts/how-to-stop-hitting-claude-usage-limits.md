...
created: 2026-05-10
updated: 2026-05-10
source_file: "How to stop hitting Claude usage limits.md"
file_type: "text"
---

# How To Stop Hitting Claude Usage Limits

**Source**: `How to stop hitting Claude usage limits.md`
...
![](https://substackcdn.com/image/fetch/$s_!ujwE!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F13fb809e-fa6f-4c3c-984b-98b3f3571651_1162x492.png)
...
1. I open a google doc (little trick, type **[doc.new](https://doc.new/)** on the URL bar).
2. I paste the text that I need to upload to Claude.
3. I download the file as an md. file.

![](https://substackcdn.com/image/fetch/$s_!I4MR!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb7f3d049-e9a1-4d41-817c-99b0206e76bd_3456x1926.png)

doc.new → paste the text → file → download → markdown (.md)
...
![](https://substackcdn.com/image/fetch/$s_!SmT_!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff9f66907-ebb7-48c0-8967-e3b31a0954c4_3456x1922.png)

You plan it on Claude (chat).

![](https://substackcdn.com/image/fetch/$s_!9FYZ!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F9c5762bd-f476-43f0-ac22-1c9d6060f95d_3456x2172.png)
...
![](https://substackcdn.com/image/fetch/$s_!gG6h!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc05eec2e-3452-4f5c-b462-5bbb2e12f596_3456x1926.png)
...
Wispr Flow is a voice-to-text tool. I explain **[how I use it everyday](https://ruben.substack.com/p/claude-cowork-20)** here.
...
<video src="blob:https://ruben.substack.com/3a1a6b33-9658-4343-8933-e2d2189e4179" controls=""></video>
...
> Access my prompt library by subscribing for **[free](https://ruben.substack.com/)** at my newsletter.
> 
...
![](https://substackcdn.com/image/fetch/$s_!shrT!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc2b6158f-e436-4a0f-951d-cd3098253047_3456x1920.png)

go to your previous message and click on the Edit button

![](https://substackcdn.com/image/fetch/$s_!BzRw!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fcbbb8e30-f7f0-4dec-a838-233e54c385ff_3456x1924.png)
...
![](https://substackcdn.com/image/fetch/$s_!hna9!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa6e8784e-f651-4eb4-9faa-7655fb07ded3_3456x1924.png)
...
![](https://substackcdn.com/image/fetch/$s_!X53U!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F9ac4216a-8cf5-4e9b-95e7-7a72e258141d_3456x2176.png)
...
![](https://substackcdn.com/image/fetch/$s_!_0hV!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd39c5012-6196-4739-83bc-1f49b3db8999_3456x2168.png)
...
![](https://substackcdn.com/image/fetch/$s_!Nz1W!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F0e46e1d1-2d81-47bd-8373-bea654e53129_3456x1928.png)
...
![](https://substackcdn.com/image/fetch/$s_!qNKi!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F8348d507-56f1-41cd-b992-8172f7637353_3456x2168.png)
...
![](https://substackcdn.com/image/fetch/$s_!VBtU!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F29496403-818f-43cc-8252-05fc08cc0e4a_3456x2168.png)
...
![](https://substackcdn.com/image/fetch/$s_!AIDo!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F6d73c698-dcf4-478d-ab13-c3bf56cf7b0f_3454x2172.png)
...
![](https://substackcdn.com/image/fetch/$s_!wpt4!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Faaee358f-bb96-48f0-bdc9-f6bd7ae5aabd_3456x2170.png)

Settings > General > Personal preferences.

![](https://substackcdn.com/image/fetch/$s_!sg0O!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fd9bb8468-b66b-4ad8-97ed-00bbde5eaea4_2554x1180.png)

I turn off Memory always. I don’t like it, it’s odd.

Also set up Styles (you’ll find it in the model selector).

![](https://substackcdn.com/image/fetch/$s_!J4gr!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ff20dcc86-3230-4c4c-9d28-4ca6b041674e_3456x2172.png)
...
![](https://substackcdn.com/image/fetch/$s_!v1II!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F688936a1-34e8-47b8-8a9f-465297946dea_2298x862.png)

Try the /schedule plugin.

![](https://substackcdn.com/image/fetch/$s_!JgnV!,w_1456,c_limit,f_webp,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F7e83bbf4-b99c-4b24-87cc-5b3f64f12e84_2382x1220.png)
...
More about **[skills](https://ruben.substack.com/p/claude-skills)** here.
